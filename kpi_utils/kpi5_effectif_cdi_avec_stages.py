...
def kpi5_effectif_cdi_avec_stages(df_arrivees):
    df = df_arrivees.copy()
    ...
    # Garder les CDI et les stagiaires
    df = df[df["Type de contrat"].str.lower().isin(["cdi", "stage"])]
    ...
    for annee in annees:
        ...
        result.append({"Année": annee, "Effectif moyen CDI + Stages": round(effectif_moyen, 2)})
